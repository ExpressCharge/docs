...
plan, usage counter, coupon, and invoice lives in [<Glossary term="Lago">Lago</Glossary>](/glossary#lago) —
...
daily are **customer**, **subscription**, **<Glossary term="Lago metric">billable metric</Glossary>**, and
...
The [<Glossary term="Lago customer">Lago customer</Glossary>](/glossary#lago-customer) is identified by an
...
A [<Glossary term="Lago subscription">Lago subscription</Glossary>](/glossary#lago-subscription) attaches a customer
...
**Idempotency via `transaction_id`.** Webhooks retry. <Glossary term="OCPP">OCPP</Glossary> messages
