...
| `.user` | Device can list chargers, start/stop sessions, manage [reservations](/glossary#reservation). Gates the Chargers tab. |
...
- `.user` → Chargers tab
- `.kiosk` → kiosk shell wrapping one of the above
