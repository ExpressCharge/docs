...
the wire between a customer's tap and a charger starting: <Glossary term="SteVe">SteVe</Glossary>'s
Pre-Authorize hook, SteVe's <Glossary term="Meter value">MeterValues</Glossary> hook, and the Cloudflare email
...
Both <Glossary term="OCPP">OCPP</Glossary> hook handlers run the same five steps in order:
