...
|---|---|---|
| Open a [<Glossary term="ChargeBox">ChargeBox</Glossary>](/glossary#chargebox) | `https://<host>/c/<id>` | `expchg://c/<id>` |
| User QR sign-in | `https://<host>/u/<publicId>` | — |
| [<Glossary term="Magic link">Magic link</Glossary>](/glossary#magic-link) sign-in | `https://<host>/m/<token>` | — |
