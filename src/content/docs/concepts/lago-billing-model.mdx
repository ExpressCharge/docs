...
plan, usage counter, coupon, and invoice lives in [Lago](/glossary#lago) —
...
daily are **customer**, **subscription**, **billable metric**, and
...
The [Lago customer](/glossary#lago-customer) is identified by an
...
A [Lago subscription](/glossary#lago-subscription) attaches a customer
...
**Idempotency via `transaction_id`.** Webhooks retry. OCPP messages
