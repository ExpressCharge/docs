...
A <Glossary term="<Glossary term="Deep link">Deep link</Glossary>">Deep link</Glossary> is a URL that iOS recognises as belonging to ExpresScan.
...
| `/u/<publicId>` | Sign in via the QR code on an <Glossary term="<Glossary term="EV card">EV card</Glossary>">EV card</Glossary> | Customers |
| `/m/<token>` | Sign in via a <Glossary term="<Glossary term="Magic link">Magic link</Glossary>">Magic link</Glossary> emailed to a customer | Customers |
...
new session and rebind the device's <Glossary term="<Glossary term="idTag">idTag</Glossary>"><Glossary term="<Glossary term="OCPP">OCPP</Glossary>">OCPP</Glossary> tag</Glossary>. Letting one fire while
