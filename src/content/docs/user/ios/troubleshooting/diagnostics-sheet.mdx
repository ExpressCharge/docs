...
Scroll to the **Test** card at the bottom and tap **Run test sync**. The button shows a loading spinner while the app forces an immediate <Glossary term="<Glossary term="<Glossary term="Sync run">Sync run</Glossary>">Sync run</Glossary>">sync run</Glossary> with the server.
