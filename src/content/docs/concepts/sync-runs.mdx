...
- **Reservation status resolver** every minute, polling pending [Reservation](/glossary#reservation) rows for SteVe confirmation.
...
- [Lago metric safety](/concepts/lago-metric-safety) — what `ensureLagoMetricSafety` guards against on worker startup.
