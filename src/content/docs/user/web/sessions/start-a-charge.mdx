...
**You're signed in as an admin acting as a customer** — <Glossary term="Impersonation">Impersonation</Glossary> is read-only. You'll get a 403 if you try to start a charge while acting as another user. Stop impersonating first.

## Related

- [Reserve a charger](/user/web/<Glossary term="Reservation">reservations</Glossary>/create-a-reservation/)
