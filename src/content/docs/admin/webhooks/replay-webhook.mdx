...
- The downstream effect landed. Depending on `event_type`, check:
  - **Lago customer / subscription events** — the relevant Lago customer or <Glossary term="<Glossary term="<Glossary term="Lago subscription">Lago subscription</Glossary>">Lago subscription</Glossary>">Lago subscription</Glossary> record in the Polaris admin reflects the change.
  - **Invoice events** — the invoice appears (or updates) under the customer's billing tab.
  - **Metric events** — the relevant <Glossary term="<Glossary term="<Glossary term="Lago metric">Lago metric</Glossary>">Lago metric</Glossary>">Lago metric</Glossary> counters move on the next sync run.
