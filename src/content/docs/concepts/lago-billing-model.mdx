...
plan, usage counter, coupon, and invoice lives in [<Glossary term="<Glossary term="Lago">Lago</Glossary>">Lago</Glossary>](/glossary#lago) —
...
daily are **customer**, **subscription**, **<Glossary term="<Glossary term="Lago metric">Lago metric</Glossary>">billable metric</Glossary>**, and
...
The [<Glossary term="<Glossary term="Lago customer">Lago customer</Glossary>">Lago customer</Glossary>](/glossary#lago-customer) is identified by an
...
A [<Glossary term="<Glossary term="Lago subscription">Lago subscription</Glossary>">Lago subscription</Glossary>](/glossary#lago-subscription) attaches a customer
...
**Idempotency via `transaction_id`.** Webhooks retry. <Glossary term="<Glossary term="OCPP">OCPP</Glossary>">OCPP</Glossary> messages
