...
them. The <Glossary term="Accent color system">accent system</Glossary> only works if every page funnels through the same
primitives.
...
- [<Glossary term="BorderBeam">BorderBeam</Glossary>](/glossary#borderbeam) — the live-state animation.
