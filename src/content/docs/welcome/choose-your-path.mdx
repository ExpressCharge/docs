...
driver. The driver docs cover the [<Glossary term="EV card">EV card</Glossary>](/glossary#ev-card) you
...
[<Glossary term="Reservation">reservations</Glossary>](/glossary#reservation), and the people allowed to use
them. The operator docs explain the admin console — how charger
state flows from [<Glossary term="OCPP">OCPP</Glossary>](/glossary#ocpp) through [<Glossary term="SteVe">SteVe</Glossary>](/glossary#steve)
into Polaris, how [<Glossary term="User mapping">user mappings</Glossary>](/glossary#user-mapping) link drivers
to [<Glossary term="Lago">Lago</Glossary> customers](/glossary#lago-customer) for billing, and how to
...
integration, [<Glossary term="BetterAuth">BetterAuth</Glossary>](/glossary#betterauth) configuration, and
...
internal subsystems like [<Glossary term="Adaptive Cadence">Adaptive Cadence</Glossary>](/glossary#adaptive-cadence)
and [<Glossary term="expreScan">expreScan</Glossary>](/glossary#expre-scan).
