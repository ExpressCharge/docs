...
The Chargers tab in [<Glossary term="<Glossary term="expreScan">expreScan</Glossary>">expreScan</Glossary>](/glossary#expre-scan) is the driver's
...
Each entry carries an online state derived from its [<Glossary term="<Glossary term="OCPP">OCPP</Glossary>">OCPP</Glossary>](/glossary#ocpp)
connection to [<Glossary term="<Glossary term="SteVe">SteVe</Glossary>">SteVe</Glossary>](/glossary#steve). A charger is *online* when SteVe
