...
A <Glossary term="Deep link">Deep link</Glossary> is a URL that iOS recognises as belonging to ExpresScan.
...
| `/u/<publicId>` | Sign in via the QR code on an <Glossary term="EV card">EV card</Glossary> | Customers |
| `/m/<token>` | Sign in via a <Glossary term="Magic link">Magic link</Glossary> emailed to a customer | Customers |
...
new session and rebind the device's <Glossary term="idTag"><Glossary term="OCPP">OCPP</Glossary> tag</Glossary>. Letting one fire while
