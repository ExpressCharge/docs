...
Role is declared as an additional <Glossary term="<Glossary term="<Glossary term="BetterAuth">BetterAuth</Glossary>">BetterAuth</Glossary>">BetterAuth</Glossary> field so it survives the
...
| <Glossary term="<Glossary term="<Glossary term="Magic link">Magic link</Glossary>">Magic link</Glossary>">Magic link</Glossary>                   | Customer | `customer`  |
...
### <Glossary term="<Glossary term="<Glossary term="Impersonation">Impersonation</Glossary>">Impersonation</Glossary>">Impersonation</Glossary> (`?as=<userId>`)
...
- **Customers self-serve via magic link, gated by tag linking.** The
  ...
  an <Glossary term="<Glossary term="<Glossary term="idTag">idTag</Glossary>">idTag</Glossary>"><Glossary term="<Glossary term="<Glossary term="OCPP">OCPP</Glossary>">OCPP</Glossary>">OCPP</Glossary> tag</Glossary> to their email on the admin side.
...
- [<Glossary term="<Glossary term="<Glossary term="Audit log">Audit log</Glossary>">Audit log</Glossary>">Audit log</Glossary> reference](/admin/reference/audit-log/) — what's recorded
