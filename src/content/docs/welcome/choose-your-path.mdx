...
driver. The driver docs cover the [<Glossary term="<Glossary term="EV card">EV card</Glossary>">EV card</Glossary>](/glossary#ev-card) you
...
[<Glossary term="<Glossary term="Reservation">Reservation</Glossary>">reservations</Glossary>](/glossary#reservation), and the people allowed to use
them. The operator docs explain the admin console — how charger
state flows from [<Glossary term="<Glossary term="OCPP">OCPP</Glossary>">OCPP</Glossary>](/glossary#ocpp) through [<Glossary term="<Glossary term="SteVe">SteVe</Glossary>">SteVe</Glossary>](/glossary#steve)
into Polaris, how [<Glossary term="<Glossary term="User mapping">User mapping</Glossary>">user mappings</Glossary>](/glossary#user-mapping) link drivers
to [<Glossary term="<Glossary term="Lago">Lago</Glossary>">Lago</Glossary> customers](/glossary#lago-customer) for billing, and how to
...
integration, [<Glossary term="<Glossary term="BetterAuth">BetterAuth</Glossary>">BetterAuth</Glossary>](/glossary#betterauth) configuration, and
...
internal subsystems like [<Glossary term="<Glossary term="Adaptive Cadence">Adaptive Cadence</Glossary>">Adaptive Cadence</Glossary>](/glossary#adaptive-cadence)
and [<Glossary term="<Glossary term="expreScan">expreScan</Glossary>">expreScan</Glossary>](/glossary#expre-scan).
