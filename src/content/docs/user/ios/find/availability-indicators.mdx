...
The Chargers tab in [<Glossary term="expreScan">expreScan</Glossary>](/glossary#expre-scan) is the driver's
...
Each entry carries an online state derived from its [<Glossary term="OCPP">OCPP</Glossary>](/glossary#ocpp)
connection to [<Glossary term="SteVe">SteVe</Glossary>](/glossary#steve). A charger is *online* when SteVe
