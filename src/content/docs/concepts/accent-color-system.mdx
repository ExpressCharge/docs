...
them. The <Glossary term="<Glossary term="Accent color system">Accent color system</Glossary>">accent system</Glossary> only works if every page funnels through the same
primitives.
...
- [<Glossary term="<Glossary term="BorderBeam">BorderBeam</Glossary>">BorderBeam</Glossary>](/glossary#borderbeam) — the live-state animation.
