...
A session in Polaris Express is anchored to a <Glossary term="SteVe">SteVe</Glossary> transaction. As you
charge, SteVe emits <Glossary term="Meter value">MeterValues</Glossary>, Polaris syncs them as
...
fetch the <Glossary term="ChargeBox">ChargeBox</Glossary>, connector, and start timestamp so the LiveSessionCard can render. If
...
- If you opened a session URL and got a "Not Found" page, the session
  either doesn't exist or isn't linked to one of your <Glossary term="EV card">EV cards</Glossary>.
