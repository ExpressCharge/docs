...
the wire between a customer's tap and a charger starting: SteVe's
Pre-Authorize hook, SteVe's MeterValues hook, and the Cloudflare email
...
Both OCPP hook handlers run the same five steps in order:
