...
If you have an upcoming <Glossary term="<Glossary term="<Glossary term="Reservation">Reservation</Glossary>">Reservation</Glossary>">reservation</Glossary>, the dashboard shows the next one — the charger's friendly name, the start time, and the end time.
