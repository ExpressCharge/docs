...
the wire between a customer's tap and a charger starting: <Glossary term="<Glossary term="SteVe">SteVe</Glossary>">SteVe</Glossary>'s
Pre-Authorize hook, SteVe's <Glossary term="<Glossary term="Meter value">Meter value</Glossary>">MeterValues</Glossary> hook, and the Cloudflare email
...
Both <Glossary term="<Glossary term="OCPP">OCPP</Glossary>">OCPP</Glossary> hook handlers run the same five steps in order:
